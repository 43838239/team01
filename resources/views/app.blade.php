...
<head>
    ...
    <style>
        ...
        /* center color */
        .bg-white{--bg-opacity:1;background-color:#fff;background:linear-gradient(red, rgba(161,219,255,1))}
        ...
        /* background color */
        .antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;background:linear-gradient(#ffffde, #bfffbf, #a1ffff)}
        .w-5{width:1.25rem}
        .w-8{width:2rem}
        .w-auto{width:auto}
...
<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
    <div class="flex justify-center pt-8 sm:pt-0">
        <img src={{ URL::asset('https://www.lhu.edu.tw/images/in/LOGO.gif') }} width="60%" height="40%"/>
    </div>
